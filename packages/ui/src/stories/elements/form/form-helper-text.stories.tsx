...
export function WithError() {
  return <FormItem.HelperText color="danger">Application helper message</FormItem.HelperText>;
}

export function WithSuccess() {
  return <FormItem.HelperText color="success">Application helper message</FormItem.HelperText>;
}